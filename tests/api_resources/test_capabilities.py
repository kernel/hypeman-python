...
from hypeman.types import Capabilities
...
class TestCapabilities:
    ...
    def test_method_get(self, client: Hypeman) -> None:
        ...
        assert_matches_type(Capabilities, capability, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_get(self, client: Hypeman) -> None:
        response = client.capabilities.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Hypeman) -> None:
        with client.capabilities.with_streaming_response.get() as response:
...
class TestAsyncCapabilities:
    ...
    async def test_method_get(self, async_client: AsyncHypeman) -> None:
        capability = await async_client.capabilities.get()
        assert_matches_type(Capabilities, capability, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_get(self, async_client: AsyncHypeman) -> None:
        response = await async_client.capabilities.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncHypeman) -> None:
        async with async_client.capabilities.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
